      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-xl mx-auto">
          <button
            ...
            className="w-full overflow-hidden border-[3px] border-white outline outline-[3px] outline-offset-2 outline-orange cursor-pointer group"
          >
            <img src={interiorImg} alt={`Inside ${siteConfig.name}`} className="w-full h-64 md:h-80 object-cover img-industrial group-hover:scale-105 transition-transform duration-700" />
          </button>
        </div>
